...
from Venus.tools.other_library.selenium.webdriver.remote.webelement import WebElement
from Venus.tools.other_library.selenium.webdriver.remote.remote_connection import RemoteConnection
from Venus.tools.other_library.selenium.webdriver.remote.errorhandler import ErrorHandler
from Venus.tools.other_library.selenium.webdriver.remote.switch_to import SwitchTo
from Venus.tools.other_library.selenium.webdriver.remote.mobile import Mobile
from Venus.tools.other_library.selenium.webdriver.remote.file_detector import FileDetector, LocalFileDetector
from Venus.tools.other_library.selenium.common.exceptions import (InvalidArgumentException,WebDriverException,NoSuchCookieException)
from Venus.tools.other_library.selenium.webdriver.common.by import By
from Venus.tools.other_library.selenium.webdriver.common.html5.application_cache import ApplicationCache
...
class WebDriver(object):
    ...
    def __init__(self, command_executor='http://127.0.0.1:4444/wd/hub',
        ...
        :Args:
         ...
         - proxy - A selenium.webdriver.public.proxy.Proxy object. The browser session will
