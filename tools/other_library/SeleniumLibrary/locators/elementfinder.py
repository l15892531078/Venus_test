...
from Venus.tools.other_library.SeleniumLibrary.base import ContextAware
from Venus.tools.other_library.SeleniumLibrary.errors import ElementNotFound
from Venus.tools.other_library.SeleniumLibrary.utils import escape_xpath_value, events, is_falsy
...
class ElementFinder(ContextAware):
    ...
    def _normalize(self, elements):
        # Apparently IEDriver has returned invalid product earlier and recently
