...
from Venus.tools.other_library.SeleniumLibrary.utils import is_noney, is_truthy
...
class FormElementKeywords(LibraryComponent):
    ...
    def get_checkbox_state(self,locator):
        '''
        查询当前checkbox是否选择true/false
        :param locator: 位置
        :return:
        '''
        return self._get_checkbox(locator=locator).is_selected()
