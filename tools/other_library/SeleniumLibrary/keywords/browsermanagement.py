...
from Venus.tools.other_library.selenium import webdriver
from Venus.tools.other_library.selenium.webdriver.support.event_firing_webdriver import EventFiringWebDriver

from Venus.tools.other_library.SeleniumLibrary.base import keyword, LibraryComponent
from Venus.tools.other_library.SeleniumLibrary.locators import WindowManager
from Venus.tools.other_library.SeleniumLibrary.utils import (is_truthy, is_noney, secs_to_timestr,
                                   timestr_to_secs)

from Venus.tools.other_library.SeleniumLibrary.keywords.webdrivertools.webdrivertools import WebDriverCreator
...
class BrowserManagementKeywords(LibraryComponent):
    ...
    def open_browser(self, url=None, browser='firefox', alias=None,
                     ...
                     ff_profile_dir=None, options=None, service_log_path=None,devType=None):
