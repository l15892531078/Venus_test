...
from Venus.tools.other_library.selenium.webdriver.common.action_chains import ActionChains
from Venus.tools.other_library.selenium.webdriver.common.keys import Keys


from Venus.tools.other_library.SeleniumLibrary.base import LibraryComponent, keyword
from Venus.tools.other_library.SeleniumLibrary.utils import (is_falsy, is_noney, is_truthy,
                                   plural_or_not as s)
from Venus.tools.other_library.SeleniumLibrary.errors import ElementNotFound
...
class ElementKeywords(LibraryComponent):
    ...
    @keyword
    def page_contain_result(self,text):
        '''
        返回页面是否包含某文本
        :param text: 文本信息
        :return: True/False
